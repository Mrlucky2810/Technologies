...
const socialLinks = [
  {
    icon: Twitter,
    href: "https://twitter.com/mwxtechnologies",
    label: "Twitter",
  },
  {
    icon: Linkedin,
    href: "https://linkedin.com/company/mwxtechnologies",
    label: "LinkedIn",
  },
  {
    icon: Instagram,
    href: "https://instagram.com/mwxtechnologies",
    label: "Instagram",
  },
  {
    icon: Youtube,
    href: "https://youtube.com/@mwxtechnologies",
    label: "YouTube",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-10">
          <div className="lg:col-span-4">
            <Link href="/" className="inline-block mb-4 cursor-pointer">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <span className="text-base font-light text-white/60 ml-1 font-body">
                    Technologies
                  </span>
                </div>
              </div>
            ...
            <p className="text-white/50 text-xs leading-relaxed mb-4 max-w-sm font-body">
              Transforming brands through innovative digital solutions. We
              combine cutting-edge technology with creative excellence.
            </p>

            <div className="space-y-2">
              <div className="flex items-center gap-2 text-white/50 text-xs font-body">
                <Mail className="w-3.5 h-3.5 text-[#8b5cf6]" />
                <span>mwxtechnologies5@gmail.com</span>
              </div>
              <div className="flex items-center gap-2 text-white/50 text-xs font-body">
                <Phone className="w-3.5 h-3.5 text-[#8b5cf6]" />
                <span>+91 79058 58145</span>
              </div>
              <div className="flex items-center gap-2 text-white/50 text-xs font-body">
          ...
          <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-6">
            <div>
              <h4 className="text-white font-semibold mb-3 text-xs uppercase tracking-wider font-heading">
                Company
              </h4>
              <ul className="space-y-2">
                {footerLinks.company.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-white/50 hover:text-[#8b5cf6] text-xs transition-colors font-body cursor-pointer"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="border-t border-[#8b5cf6]/10 pt-6">
          ...
          <div className="mt-6 pt-4 border-t border-[#8b5cf6]/10 flex flex-col md:flex-row justify-between items-center gap-2">
            <p className="text-white/30 text-[10px] text-center md:text-left font-body">
              © 2025 MWX Technologies. All rights reserved.
            </p>
